...
let dummyProfiles: [UserProfile] = [
    ...
    UserProfile(uid:"test", name: "", age: 22, bio: "Hanging out with friends", foods: ["chinese", "asian"], imageName: "emily", gender: "female", locationGeoPoint: GeoPoint(latitude: 34.0522, longitude: -115.1398))
]
